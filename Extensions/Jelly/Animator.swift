...
public protocol LiveUpdatable {
    ...
    func updateAlignment(alignment: PresentationAlignmentProtocol, duration: JellyDuration) throws
    func updateVerticalAlignment(alignment: VerticalAlignment, duration: JellyDuration) throws
    func updateHorizontalAlignment(alignment: HorizontalAlignment, duration: JellyDuration) throws
    func updateSize(presentationSize: PresentationSize, duration: JellyDuration) throws
    func updateWidth(width: JellySize, duration: JellyDuration) throws
    func updateHeight(height: JellySize, duration: JellyDuration) throws
...
extension Animator: LiveUpdatable {
    ...
    public func updateVerticalAlignment(alignment: VerticalAlignment, duration: JellyDuration) throws {
        guard !(presentation is SlidePresentation), var presentation = presentation as? (Presentation & PresentationAlignmentProvider) else {
            throw LiveUpdateError.notSupportedOnSlide
        }
    ...
    public func updateHorizontalAlignment(alignment: HorizontalAlignment, duration: JellyDuration) throws {
        guard !(presentation is SlidePresentation), var presentation = presentation as? (Presentation & PresentationAlignmentProvider) else {
            throw LiveUpdateError.notSupportedOnSlide
        }
    ...
    public func updateSize(presentationSize: PresentationSize, duration: JellyDuration) throws {
    ...
    public func updateWidth(width: JellySize, duration: JellyDuration) throws {
    ...
    public func updateHeight(height: JellySize, duration: JellyDuration) throws {
        guard !(presentation is SlidePresentation) else {
            throw LiveUpdateError.notSupportedOnSlide
        }
    ...
    public func updateMarginGuards(marginGuards: UIEdgeInsets, duration: JellyDuration) throws {
    ...
    public func updateCorners(radius: CGFloat, corners: CACornerMask, duration: JellyDuration) {
